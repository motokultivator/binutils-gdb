/* THIS FILE IS GENERATED.  -*- buffer-read-only: t -*- vi:set ro:
  Original: nanomips64-dsp-linux.xml */

#include "defs.h"
#include "osabi.h"
#include "target-descriptions.h"

struct target_desc *tdesc_nanomips64_dsp_linux;
static void
initialize_tdesc_nanomips64_dsp_linux (void)
{
  target_desc_up result = allocate_target_description ();
  set_tdesc_architecture (result.get (), bfd_scan_arch ("nanomips"));

  set_tdesc_osabi (result.get (), osabi_from_tdesc_string ("GNU/Linux"));

  struct tdesc_feature *feature;

  feature = tdesc_create_feature (result.get (), "org.gnu.gdb.nanomips.cpu");
  ...
  tdesc_create_reg (feature, "pc", 32, 1, NULL, 64, "int");

  feature = tdesc_create_feature (result.get (), "org.gnu.gdb.nanomips.linux");
  tdesc_create_reg (feature, "restart", 33, 1, "system", 64, "int");

  feature = tdesc_create_feature (result.get (), "org.gnu.gdb.nanomips.cp0");
  ...
  feature = tdesc_create_feature (result.get (), "org.gnu.gdb.nanomips.fpu");
  ...
  feature = tdesc_create_feature (result.get (), "org.gnu.gdb.nanomips.dsp");
  tdesc_create_reg (feature, "hi0", 71, 1, NULL, 64, "int");
  tdesc_create_reg (feature, "lo0", 72, 1, NULL, 64, "int");
  ...
  tdesc_nanomips64_dsp_linux = result.get ();
}
